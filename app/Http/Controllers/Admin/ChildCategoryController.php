...
class ChildCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('image')) {
            ...
            return redirect()->route('admin.childcategories.index')->with('message', 'Child Category created.');
            ;
        }
        dd('no image');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            return redirect()->route('admin.childcategories.index')->with('message', 'Child category updated with image.');
            ;
        } else {
            $child_category->update([
                'name' => $request->name,
            ...
            return redirect()->route('admin.childcategories.index')->with('message', 'Child Category updated.');
            ;
        }
    }
